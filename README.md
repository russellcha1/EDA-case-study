...
Data analysis
First chart generated in script shows the categorical views spread out over the day/month/year.
Second chart shows the raw likes and dislikes enabling analysis on direct interaction with content.
Third chart shows the ratio between likes and dislikes which showcases controversy on the content. 

Findings
Entertainment and Music typically highest. If content creators works don't fall in these two categories, a different presentation medium may be warranted. If content can be packaged into the top categories, viewership may increase.
